...
func (c *MarkdownConverter) Convert(tab gws.Tab) string {
...
func (c *MarkdownConverter) writeParagraph(sb *strings.Builder, p *gws.Paragraph, lists map[string]gws.List) {
...
func (c *MarkdownConverter) extractText(p *gws.Paragraph) string {
	var parts []string
...
func (c *MarkdownConverter) applyTextStyle(text string, style gws.TextStyle) string {
...
func (c *MarkdownConverter) isOrderedList(bullet *gws.Bullet, lists map[string]gws.List) bool {
	if lists == nil {
		return false
	}
...
func (c *MarkdownConverter) writeTable(sb *strings.Builder, t *gws.Table) {
...
func (c *MarkdownConverter) extractCellText(cell gws.TableCell) string {
	var parts []string
